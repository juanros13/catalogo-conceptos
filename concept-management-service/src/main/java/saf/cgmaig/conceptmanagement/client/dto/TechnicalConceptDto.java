...
/**
 * DTO para conceptos técnicos base obtenidos del technical-concept-service
 * 
 * Representa conceptos base creados por validadores técnicos que servirán
 * como punto de partida para conceptos específicos de áreas.
 */
public class TechnicalConceptDto {
    ...
    /**
     * Verifica si el concepto está activo
     */
    ...
    /**
     * Obtiene información resumida para mostrar en listas
     */
    public String getSummary() {
        return String.format("%s - %s (%s)", name, area, chapter);
    }
